...
//   async function clicouNoLixoo(postId) {
//     try {
...
const clicouNoLixo = (postId) => {
  // openDeleteModal();
  alert("tentou deletar")
};
  ...
  <TbTrashFilled onClick={openDeleteModal} color="#FFFFFF" size="25" />
</ContainerTrashRow>
...
>
  ...
  <button onClick={() => clicouNoLixo(post.id)}>Yes</button>
